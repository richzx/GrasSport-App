      ...
      <section className='flex flex-col items-end gap-[1.25rem] '>
        <div className='flex flex-col gap-3'>
          <div className='flex flex-col gap-5 md:flex-row'>
            <input className='focus:outline-none bg-[#0720040a] text-w05 p-4 w-[300px] rounded-lg shadow-md sm:w-[400px] md:w-[300px]' id="nombre" type="text" placeholder="Nombre"/>
            <input className='focus:outline-none bg-[#0720040a] text-w05 p-4 w-[300px] rounded-lg shadow-md sm:w-[400px] md:w-[300px]' id="apellido" type="text" placeholder="Apellido"/>
          </div>
